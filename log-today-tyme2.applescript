--------------------------------------------------------------------------------
-- Use Tyme2's AppleScript API to export today's data, then use Bala's
-- log script to push that data to Teamwork.
-- This file needs to be in the same directory as Bala's log script.
-- To use (from the command line):
--    $ osascript log-today-tyme2.applescript
--------------------------------------------------------------------------------
...
on run
  tell application "Finder"
    ...
    set _filename to _path & "log-today-tyme2.csv"
  ...
  set _results to (do shell script "./log -f log-today-tyme2.csv")
